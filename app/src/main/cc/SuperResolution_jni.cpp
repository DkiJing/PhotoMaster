...
namespace tflite {
    namespace examples {
        namespace superresolution {
            ...
            Java_com_example_photomaster_photoEdit_superResolutionFromJNI(
            ...
            Java_com_example_photomaster_photoEdit_initWithByteBufferFromJNI(
            ...
            Java_com_example_photomaster_photoEdit_deinitFromJNI(
